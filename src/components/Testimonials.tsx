...
const Testimonials = () => {
  ...
  {
    name: "Sanjeet Tiwari",
    role: "Final Year Project Partner",
    content:
      "Collaborating with Dhiraj on our final year project was a great experience. He handled the backend seamlessly and was always quick to debug and fix issues.",
    rating: 5,
    avatar: "/sanjeet.png",
  },
  {
    name: "Kshitij Kumar",
    role: "Team Lead, AdoptUs Project",
    content:
      "Dhiraj managed most of the frontend and also helped with backend integrations. His attention to detail and UI skills made a big difference in our project.",
    rating: 5,
    avatar: "/kshitij.png",
  },
  {
    ...
    content:
      "I shared a Figma design and Dhiraj turned it into a live UI exactly as expected. He also suggested a few improvements that made the final design even better.",
    rating: 4,
    avatar: "/aarohi.png",
  },
];
        ...
        <svg className="absolute inset-0 w-full h-full">
          {Array.from({ length: 6 }).map((_, i) => (
            <motion.line
              ...
              opacity="0.3"
              strokeDasharray="3,3"
              animate={{ strokeDashoffset: [0, -6], opacity: [0.2, 0.6, 0.2] }}
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            Feedback from peers, teammates and reviewers
          </p>
        </motion.div>
