...
const Projects = () => {
  ...
  const projects = [
    {
      title: "Lettrics AI Writer",
      description:
        "Built a cross-platform AI writing app with Essay, Story, Poem, Letter, and Content generators. Built with Next.js, Tailwind, and Framer Motion. Fully responsive and mobile-optimized.",
      tech: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
      ...
      image:
        "/project6.png",
      liveUrl: "https://Lettrics.com",
      githubUrl: "#",
    },
    {
      title: "NetFrix: Online Watching Series & Movie App",
      description:
        "Developed a full-fledged streaming app with HLS video delivery, Cloudflare R2 storage, and a custom WebView Android app.",
      tech: [
        "Next.js",
        "TypeScript",
        "MongoDB",
    ...
    {
      title: "AdoptUs - A Pet Adoption Platform",
      description:
        "Final year MERN project with dynamic pet listings, admin approval, and user authentication using OTP. Includes services, shops, and real-time counters.",
      tech: ["React", "Node.js", "MongoDB", "Express", "Cloudinary", "Tailwind CSS", "Figma", "JWT Auth"],
      image: "/project3.png",
      liveUrl: "adoptus.fallmodz.in",
      githubUrl:
        "https://github.com/CodeByDhiraj/adoptus-client",
    },
    {
      title: "FallModz Official Website",
      description:
        "Developed a cross-platform automation system for decrypting and unpacking encrypted game files to preview unreleased content. The pipeline combines asset extractors, CLI tools, and automation scripts on a secure Linux VPS, triggered via Telegram bot commands. Features include asset decryption, image extraction, zipping, mobile processing, and delivery automation—built with a focus on performance, security, and scalability.",
      tech: [
        "JavaScript",
        "Tailwind CSS",
        "Figma",
        "Analytics",
        "QuickBMS", "Shell Scripting", "Telegram Bot",
        "Linux","Node.js", "Termux", "UModel"
      ],
      image: "/project4.png",
      liveUrl: "https://fallmodz.in",
      githubUrl: "#",
    },
    {
      title: "Modern Web Showcase – Clean Business UI",
      description:
      ...
      <div className="container mx-auto relative z-10">
        ...
        >
          ...
          >
            <Button
              onClick={() =>
                window.open("https://github.com/CodeByDhiraj", "_blank")
              }
              size="lg"
