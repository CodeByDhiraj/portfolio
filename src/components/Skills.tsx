...
import { siAuth0 } from "simple-icons/icons";
        ...
        >
          {categories.map((category, index) => (
            <motion.button
              ...
              className={`px-6 py-3 rounded-full border transition-all duration-300 font-medium ${selectedCategory === category
