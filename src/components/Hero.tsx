...
const developerPhoto =
  "/Dhiraj/IMG_20250703_231857.png";
      ...
      <div className="container mx-auto px-2 z-10">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[80vh] lg:min-h-0 md:mt-[5rem]">
          ...
          >
            ...
            >
              Turning passion into products and logic into life. 
              I build full-stack solutions with cutting-edge tech,
              constant learning, and a spark for digital change.
